...
<template>
    <div class="container" id="main_page">
        ...
        <!-- <div class="row mt-5 item_product">
            <h4> <i class="fa-solid fa-fire"></i> XU HƯỚNG MUA SẮM - SẢN PHẨM BÁN CHẠY CỦA THÁNG</h4>
        ...
        <!-- <div class="row container mt-5">
            <div class="col" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                <img src="https://htmldemo.net/pustok/pustok/image/bg-images/promo-banner-with-text.jpg"
                    class="img-fluid" alt="..." width="100%">
            </div>
            <div class="col" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                <img src="https://htmldemo.net/pustok/pustok/image/bg-images/promo-banner-with-text-2.jpg"
                    class="img-fluid" alt="..." width="100%">
            </div>
        </div> -->
