...
<template>
    <button type="button" id="btn_addBook" class="btn btn-success" @click="addBook()"><i class="fa-solid fa-plus"></i>
        Thêm Sách </button>
    ...
    <form @submit.prevent id="form_addBook" style="display:none;width:100%;">
        ...
        <div class="mb-3">
            ...
            <select class="form-control" :required="true" @change="changeOptionTL" id="chooseTL">
                <option v-for="item in ManageBookType" v-bind:value="item.booktype_name">{{ item.booktype_name }}
                </option>
            </select>
        </div>
