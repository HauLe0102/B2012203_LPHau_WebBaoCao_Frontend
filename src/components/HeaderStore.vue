...
<template>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" id="top_nav">
        <div class="container" style="height: 82px;">
            <a class="navbar-brand" href="/" style="margin-right:150px;margin-top:15px;">
                <img src="../assets/img/logo2.png" class="img-fluid" alt="..." width="150" height="150">
            </a>
            ...
            <div class="navbar-brand" href="#"
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1"
                        style="list-style:none;color:black;font-size:15px">
