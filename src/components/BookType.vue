...
<template>
    <button type="button" id="btn_addAuthor" class="btn btn-success" @click="addBookType()"><i
    ...
    <form action="/" class="d-flex" style="width:500px;margin:0 auto" id="inputSearchKeyWord" @submit.prevent>
        <input type="text" class="form-control" placeholder="Nhập vào tên thể loại..." aria-label="Recipient's username"
        ...
        <button id="btn_search" type="submit" style="width:120px;height:50px;border-radius:0 6px 6px 0"
            @click="FindAuthor(inputSearch)">Tìm Kiếm</button>
    </form>
    <br>
    <br>
    ...
    <form @submit.prevent id="form_addBookType" style="display:none;width:100%;">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                placeholder="Vui lòng nhập vào thể loại..." v-model="BookTypeInput.booktype_name" required>
            ...
            <select class="form-control" :required="true" @change="changeOption" id="chooseDM">
                ...
                <option v-for="item in ManageCategory" v-bind:value="item.category_name">{{ item.category_name }}
                </option>
            </select>
        </div>

        <button @click="handleAddBookType()" type="submit" class="btn btn-light fw-bold"
        ...
        <tbody>
            <tr v-for="(item, index) in ManageBookType">
                ...
                <td>
                    ...
                    <button @click="deleteBookType(item._id)" type="button" class="btn btn-danger"> <i
