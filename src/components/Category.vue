...
<template>
    <button type="button" id="btn_addCategory" class="btn btn-success" @click="addCategory()"><i
    ...
    <form action="/" class="d-flex" style="width:500px;margin:0 auto" id="inputSearchKeyWord" @submit.prevent>
        <input type="text" class="form-control" placeholder="Nhập vào tên danh mục..." aria-label="Recipient's username"
        ...
        <button id="btn_search" type="submit" style="width:120px;height:50px;border-radius:0 6px 6px 0"
            @click="FindCategory(inputSearch)">Tìm Kiếm</button>
    </form>
    <br>
    <br>
    ...
    <form @submit.prevent id="form_addCategory" style="display:none;width:100%;">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                placeholder="Vui lòng nhập vào tên sách..." v-model="CategoryInput.category_name" required>
        </div>

        <button @click="handleAddCategory()" type="submit" class="btn btn-light fw-bold"
        ...
        <tbody>
            <tr v-for="(item, index) in ManageCategory">
                ...
                <td>
                    ...
                    <button @click="deleteCategory(item._id)" type="button" class="btn btn-danger"> <i
