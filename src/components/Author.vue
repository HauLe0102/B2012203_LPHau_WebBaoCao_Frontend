...
<template>
    <button type="button" id="btn_addAuthor" class="btn btn-success" @click="addAuthor()"><i
            class="fa-solid fa-plus"></i> Thêm Tác Giả </button>


    <form action="/" class="d-flex" style="width:500px;margin:0 auto" id="inputSearchKeyWord" @submit.prevent>
        <input type="text" class="form-control" placeholder="Nhập vào tên tác giả..." aria-label="Recipient's username"
        ...
        <tbody>
            <tr v-for="(item, index) in ManageAuthor">
                ...
                <td>
                    ...
                    <button @click="deleteAuthor(item._id)" type="button" class="btn btn-danger"> <i
